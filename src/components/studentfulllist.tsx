                  ...
                  <tr>
                    <td colSpan={4} className="py-32 text-center">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-zinc-500 text-xs uppercase tracking-widest font-black">Scanning Database...</p>
                      </div>
                    </td>
                  </tr>
                ) : data.length > 0 ? (
                      ...
                      >
                        <td className="px-8 py-6">
                          <div className="flex items-center gap-5">
                            ...
                            <div>
                              <p className="font-bold text-zinc-100 text-lg group-hover:text-purple-400 transition-colors">
                                {student.name}
                              </p>
