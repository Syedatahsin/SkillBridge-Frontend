          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4 pt-4">
              {[Github, Linkedin, Instagram].map((Icon, i) => (
                <Button key={i} variant="outline" size="icon" className="rounded-full border-white/10 bg-white/5 hover:bg-purple-600 hover:border-purple-600 transition-all">
                  <Icon size={18} />
                </Button>
              ))}
            </div>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input placeholder="John Doe" className="bg-black/50 border-white/10 rounded-2xl h-12 focus-visible:ring-purple-500" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-gray-500 uppercase ml-2">Email</label>
                  <Input placeholder="john@example.com" className="bg-black/50 border-white/10 rounded-2xl h-12 focus-visible:ring-purple-500" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <Button className="w-full h-14 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 transition-all text-lg font-bold shadow-lg shadow-purple-500/20">
                Send Message
