...
export default function TeacherListPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-purple-500/30">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <input 
                ...
                className="w-full h-16 bg-[#0A0A0B] border border-white/10 rounded-2xl pl-16 pr-6 text-sm italic focus:outline-none focus:border-purple-600 transition-all"
              />
            </div>
            <button className="h-16 px-8 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-3 font-black uppercase text-[10px] tracking-widest hover:bg-white/10 transition-all">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {tutors.map((tutor) => (
            <div 
              key={tutor.id} 
              className="group bg-[#0A0A0B] border border-white/10 rounded-[3rem] p-8 hover:border-purple-600/50 transition-all duration-500 flex flex-col"
            >
              {/* Profile Card Header */}
              <div className="flex justify-between items-start mb-8">
                <div className="relative">
                  <div className="size-24 rounded-[1.8rem] bg-gradient-to-tr from-purple-600 to-fuchsia-600 p-[2px]">
                    <div className="size-full bg-[#0A0A0B] rounded-[1.7rem] overflow-hidden">
                  ...
                  <div className="absolute -bottom-1 -right-1 bg-emerald-500 p-1.5 rounded-lg border-2 border-[#0A0A0B]">
                ...
                <div className="text-right">
                  <div className="flex items-center gap-1 justify-end">
                    ...
                    <span className="font-black text-sm">{tutor.rating}</span>
                  </div>
                  <p className="text-[9px] font-bold text-gray-500 uppercase tracking-tighter mt-1">{tutor.reviewCount} Reviews</p>
                </div>
              </div>

              {/* Bio Section */}
              <div className="flex-1 space-y-2 mb-8">
                <h3 className="text-2xl font-black italic tracking-tighter">{tutor.name}</h3>
              ...
              <div className="pt-6 border-t border-white/5 flex items-center justify-between">
                <div>
                  <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest leading-none mb-1">Session Rate</p>
                  <p className="text-xl font-black tracking-tight">${tutor.price}.00<span className="text-xs text-gray-500">/hr</span></p>
                </div>
                <button className="size-14 rounded-2xl bg-white text-black flex items-center justify-center hover:bg-purple-600 hover:text-white transition-all group/btn">
        ...
        <div className="mt-24 flex items-center justify-center gap-4">
          <button 
            ...
            className="size-14 rounded-2xl border border-white/10 flex items-center justify-center hover:bg-white/5 transition-all disabled:opacity-20"
          ...
          <button 
            ...
            className="size-14 rounded-2xl border border-white/10 flex items-center justify-center hover:bg-white/5 transition-all"
          >
      ...
      {/* --- FOOTER BANNER --- */}
      <footer className="py-20 px-6 bg-[#080809] border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
           ...
           <p className="text-gray-600 text-[10px] font-bold uppercase tracking-widest">© 2026 TutorVibe Marketplace</p>
        </div>
      </footer>
    </div>
  );
